...
function Navbar() {
  ...
  const initializeRoomSliceStates = useConnectionStore(
    (s) => s.initializeRoomSliceStates,
  );
  const initializeSocketSliceStates = useConnectionStore(
    (s) => s.initializeSocketSliceStates,
  );
  const initializeMediaStreamSliceStates = useConnectionStore(
    (s) => s.initializeMediaStreamSliceStates,
  );
  const initializeDeviceSliceStates = useConnectionStore(
    (s) => s.initializeDeviceSliceStates,
  );
  const initializeTransportSliceStates = useConnectionStore(
    (s) => s.initializeTransportSliceStates,
  );
  const initializeProducerSliceStates = useConnectionStore(
    (s) => s.initializeProducerSliceStates,
  );
  const initializeConsumerSliceStates = useConnectionStore(
    (s) => s.initializeConsumerSliceStates,
  );
